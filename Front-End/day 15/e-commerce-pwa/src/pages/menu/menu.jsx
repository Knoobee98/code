...
let Menu = () => {
    ...
    // let onGetData = async() => {
    //     try {
    //         let response = await axios.get(`https://my-json-server.typicode.com/Knoobee98/jsonServer-Ecommerce-apps/products`)
    //         let responseCategory = await axios.get(`https://my-json-server.typicode.com/Knoobee98/jsonServer-Ecommerce-apps/category`)
    ...
    let onGetData = async() => {
        try{
            let response = await axios.get('https://my-json-server.typicode.com/Knoobee98/jsonServer-Ecommerce-apps/products?category=0');
            let responseCategory = await axios.get('https://my-json-server.typicode.com/Knoobee98/jsonServer-Ecommerce-apps/category')
    ...
    let onFilter = async(idx) => {
        let response = await axios.get(`https://my-json-server.typicode.com/Knoobee98/jsonServer-Ecommerce-apps/products?category=${idx}`);
