    ...
    return(
        ...
        <div className="flex flex-col items-center m-24 border rounded-md">
            ...
            <div className="flex flex-col items-center p-4">
                ...
                <input type='text' placeholder="email/username" className="border border-black rounded-md py-3 px-24 mt-4"/>
                <p className="mt-4">Password</p>
                <input type='password' placeholder="password" className="border border-black rounded-md py-3 px-24 mt-4"/>
                <div>
                    <button className="px-6 py-2 bg-green-500 border border-slate-200 rounded-full mt-7">Login</button>
                </div>
